                ...
                <div className="about-me__works">
                    ...
                    <ul className="about-me__sites">
                        <li className='about-me__list-item'>
                            <a className="about-me__site" target="_blank" href='https://naruls.github.io/how-to-learn/' rel='noreferrer'>
                                <p className="about-me__site-name">Статичный сайт</p>
                                <img className="about-me__site-arrow" src={arrow} alt="ссылка" />
                            </a>
                        </li>
                        <li className='about-me__list-item'>
                            <a className="about-me__site" target="_blank" href='https://naruls.github.io/russian-travel/' rel='noreferrer'>
                                <p className="about-me__site-name">Адаптивный сайт</p>
                                <img className="about-me__site-arrow" src={arrow} alt="ссылка" />
                            </a>
                        </li>
                        <li className='about-me__list-item'>
                            <a className="about-me__site" target="_blank" href='https://narulsimagesaving.ru' rel='noreferrer'>
